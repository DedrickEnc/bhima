(function (angular) {
  ...
  var bhima = angular.module('bhima', ['bhima.controllers', 'bhima.services', 'bhima.directives', 'bhima.filters', 'angularGrid', 'ngRoute', 'ui.bootstrap', 'pascalprecht.translate', 'LocalForageModule']);
